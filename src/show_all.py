...
for entry in district4:
    print(f"District: {entry.district_id}, Federal Revenue: {entry.federal_revenue}, Local Revenue: {entry.local_revenue}, State Revenue: {entry.state_revenue}, Total Expenditures: {entry.total_expenditures}, Total Revenue: {entry.total_revenue} Year: {entry.year}")
